...
function About() {
  return (
    <main className="about-wrapper md:justify-center flex md:flex-row flex-col-reverse md:pt-14" id="about"> 
      ...
      <div>
        <a target="_blank" rel="noreferrer" href="https://www.github.com/tplatts04" className="my-auto"><img src={profile} alt="Profile img" className="md:min-w-52 md:mt-20 rounded-3xl border-4 border-white w-52 mx-auto hover:accent lg:min-w-80 lg:mt-12 transition-shadow pfp" /></a>
      </div>
      <div className="md:absolute mx-auto mb-20 md:mt-96 pt-5">
        <a href="https://www.github.com/tplatts04" target="_blank" rel="noreferrer"><i class="fa-brands fa-github text-5xl mr-5 cursor-pointer hover:scale-110 transition-transform github"></i></a>
        <a href="https://www.linkedin.com/in/thomas-platts-0608a1256/" target="_blank" rel="noreferrer"><i class="fa-brands fa-linkedin  text-5xl cursor-pointer hover:scale-110 transition-transform linkedin"></i></a>
      </div>
    </main>
  )
}
