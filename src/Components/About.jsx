...
function About() {
  return (
    <main className="about-wrapper flex justify-center md:flex-row flex-col-reverse" id="about">
      ...
      <div>
        <a target="_blank" rel="noreferrer" href="https://www.github.com/tplatts04"><img src={profile} alt="Profile img" className="md:w-52 md:mt-16 rounded-3xl border-4 border-white w-52 mx-auto mt-5" /></a>
      </div>
    </main>
  )
}
