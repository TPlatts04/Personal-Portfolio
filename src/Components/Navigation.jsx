...
function Navigation() {
  ...
  return (
    <nav className="navigation-bar fixed flex flex-row justify-around bg-gradient-to-r from-violet-700 to-fuchsia-600 text-white py-2 shadow-md shadow-violet-700 md:text-sm text-xxs min-w-full" >
      <div>
      ...
      <div>
        <a href="/"><h4 className="text-white text-shadow hover:scale-110 hover:text-black hover:underline transition-transform mt-1">Tech Stack</h4></a>
      </div>
      <div>
